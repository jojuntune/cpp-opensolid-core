...
#ifndef OPENSOLID__CONCATENATIONFUNCTION_HPP
#define OPENSOLID__CONCATENATIONFUNCTION_HPP

#include "BinaryFunction.hpp"

namespace opensolid
{
    class ConcatenationFunction : public BinaryFunction
    {
    public:
        OPENSOLID_EXPORT ConcatenationFunction(
