...
#ifndef OPENSOLID__DIFFERENCEFUNCTION_HPP
#define OPENSOLID__DIFFERENCEFUNCTION_HPP

#include "BinaryFunction.hpp"

namespace opensolid
{
    class DifferenceFunction : public BinaryFunction
    {
    public:
        OPENSOLID_EXPORT DifferenceFunction(
