...
namespace opensolid
{
    ...
    void CrossProductFunction::getValues(const MapXd& parameter_values, MapXd& results) const {
    ...
    void CrossProductFunction::getBounds(const MapXI& parameter_bounds, MapXI& results) const {
