...
namespace Eigen
{
    namespace internal
    {
        ...
        struct traits<opensolid::JacobianEvaluation<iNumDimensions, iNumParameters, TArgument>>
        {
        ...
        struct traits<opensolid::JacobianEvaluation<iNumDimensions, 1, int>>
        {
        ...
        template <int iNumDimensions>
        struct traits<opensolid::JacobianEvaluation<iNumDimensions, 1, double>>
        {
            typedef Matrix<double, iNumDimensions, 1> ReturnType;
        ...
        template <int iNumDimensions>
        struct traits<opensolid::JacobianEvaluation<iNumDimensions, 1, opensolid::Interval>>
        {
...
namespace opensolid
{
    ...
    class JacobianEvaluation :
        public ReturnByValue<JacobianEvaluation<iNumDimensions, iNumParameters, TArgument>>
    {
    private:
    ...
    template <int iNumDimensions>
    class JacobianEvaluation<iNumDimensions, 1, int> :
        public ReturnByValue<JacobianEvaluation<iNumDimensions, 1, int>>
    {
    private:
        const ExpressionImplementation* _expressionImplementationPtr;
        double _argument;
    ...
    template <int iNumDimensions>
    class JacobianEvaluation<iNumDimensions, 1, double> :
        public ReturnByValue<JacobianEvaluation<iNumDimensions, 1, double>>
    {
    private:
        const ExpressionImplementation* _expressionImplementationPtr;
        double _argument;
    ...
    template <int iNumDimensions>
    class JacobianEvaluation<iNumDimensions, 1, Interval> :
        public ReturnByValue<JacobianEvaluation<iNumDimensions, 1, Interval>>
    {
    private:
        const ExpressionImplementation* _expressionImplementationPtr;
        Interval _argument;
