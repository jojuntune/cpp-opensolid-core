...
namespace opensolid
{
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, iNumParameters, TArgument>::rows() const {
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, iNumParameters, TArgument>::cols() const {
    ...
    inline
    void
    ExpressionEvaluation<iNumDimensions, iNumParameters, TArgument>::evalTo(TResult& result) const {
    ...
    ExpressionEvaluation<iNumDimensions, iNumParameters, TArgument>::value() const {
    ...
    inline
    bool
    ExpressionEvaluation<iNumDimensions, iNumParameters, TArgument>::isZero(
        double precision
    ) const {
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, int>::rows() const {
        return iNumDimensions;
    }
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, int>::cols() const {
        return 1;
    }
    ...
    inline
    void
    ExpressionEvaluation<iNumDimensions, 1, int>::evalTo(TResult& result) const {
        // Create argument map
    ...
    inline
    double
    ExpressionEvaluation<iNumDimensions, 1, int>::value() const {
    ...
    inline
    bool
    ExpressionEvaluation<iNumDimensions, 1, int>::isZero(double precision) const {
        return this->eval().isZero(precision);
    }
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, double>::rows() const {
        return iNumDimensions;
    }
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, double>::cols() const {
        return 1;
    }
    ...
    inline
    void
    ExpressionEvaluation<iNumDimensions, 1, double>::evalTo(TResult& result) const {
        // Create argument map
        typedef Map<const MatrixXd, Unaligned, Stride<Dynamic, Dynamic>> ArgumentMapType;
        ArgumentMapType argumentMap(&_argument, 1, 1, Stride<Dynamic, Dynamic>(0, 0));
    ...
    inline
    double
    ExpressionEvaluation<iNumDimensions, 1, double>::value() const {
        Matrix<double, 1, 1> result;
        this->evalTo(result);
        return result.value();
    }
    ...
    inline
    bool
    ExpressionEvaluation<iNumDimensions, 1, double>::isZero(double precision) const {
        return this->eval().isZero(precision);
    }
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, Interval>::rows() const {
        return iNumDimensions;
    }
    ...
    inline
    int
    ExpressionEvaluation<iNumDimensions, 1, Interval>::cols() const {
        return 1;
    }
    ...
    inline
    void
    ExpressionEvaluation<iNumDimensions, 1, Interval>::evalTo(TResult& result) const {
        // Create argument map
    ...
    inline
    Interval
    ExpressionEvaluation<iNumDimensions, 1, Interval>::value() const {
    ...
    inline
    bool
    ExpressionEvaluation<iNumDimensions, 1, Interval>::isZero(double precision) const {
        return this->eval().isZero(precision);
    }
}
