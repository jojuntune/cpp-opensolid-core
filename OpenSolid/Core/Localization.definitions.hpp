...
namespace opensolid
{
    ...
    class Localization :
        public Transformation<Localization<iNumDimensions>>
    {
    private:
        Frame<iNumDimensions> _frame;
    public:
        Localization(const Frame<iNumDimensions>& frame);
    ...
    typedef Localization<2> Localization2d;
    typedef Localization<3> Localization3d;
}
