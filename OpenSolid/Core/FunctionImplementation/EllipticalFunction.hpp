...
namespace opensolid
{
    ...
    EllipticalFunction::originPoint() const {
        return _originPoint;
    }

    inline const MatrixXd&
    EllipticalFunction::basisMatrix() const {
        return _basisMatrix;
    }
    
    inline const RowVectorXb&
    EllipticalFunction::convention() const {
        return _convention;
    }
}
