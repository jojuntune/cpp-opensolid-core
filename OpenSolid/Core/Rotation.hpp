...
namespace opensolid
{
    ...
    Rotation2d::originPoint() const {
        return _originPoint;
    }

    inline const Matrix2d&
    Rotation2d::transformationMatrix() const {
    ...
    Rotation3d::originPoint() const {
        return _originPoint;
    }

    inline const Matrix3d&
    Rotation3d::transformationMatrix() const {
        return _transformationMatrix;
    }
