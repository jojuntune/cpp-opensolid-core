...
namespace OpenSolid
{
    ...
    public:
        ...
        template <class VisitorType>
        void visit(const VisitorType& visitor, const Bounds& overlapping_bounds) const;

        template <class VisitorType, class BoundsPredicateType>
        void visit(const VisitorType& visitor, const BoundsPredicateType& bounds_predicate) const;
        ...
        void filter(const Bounds& overlapping_bounds, OutputIteratorType output_iterator) const;
        ...
        void filterIf(const PredicateType& predicate, OutputIteratorType output_iterator) const;
...
{   
    ...
    template <class Type, class BoundsFunctionType> template <class VisitorType>
    void Set<Type, BoundsFunctionType>::visit(
        const VisitorType& visitor,
        const Bounds& overlapping_bounds
    ) const {
        if (root()) {
    ...
    template <class Type, class BoundsFunctionType>
    template <class VisitorType, class BoundsPredicateType>
    inline void Set<Type, BoundsFunctionType>::visit(
        const VisitorType& visitor,
        const BoundsPredicateType& bounds_predicate
    ...
    void Set<Type, BoundsFunctionType>::filter(
        const Bounds& overlapping_bounds,
        OutputIteratorType output_iterator
    ) const {
        if (root()) {
    ...
    template <class Type, class BoundsFunctionType>
    template <class PredicateType, class OutputIteratorType>
    void Set<Type, BoundsFunctionType>::filterIf(
        const PredicateType& predicate,
        OutputIteratorType output_iterator
    ) const {
        if (root()) {
